...
const handleNavegation = async (routeName: string) => {
...
<template>
  <nav
    class="flex justify-between items-center shadow-sm text-slate-700 py-3 bg-white px-4 sm:px-6 lg:px-20 relative"
  >
    <CardOptionNav
